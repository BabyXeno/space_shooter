...
let longestTimeAliveHighScore = 0;
// high score
let stars = [];
let player;
let asteroids = [];
...
longestTimeAliveHighScore = localStorage.getItem("longestTimeAliveHighScore") ||
  0;
longestTimeAliveHighScore = parseInt(longestTimeAliveHighScore);
...
planetaryBackground.src = "planet.png";
...
function initializeGame() {
  ...
  let i = 0;
  for (let colorName in availableColors) {
    let textColor = colorName === "White" ? BLACK : WHITE; 
